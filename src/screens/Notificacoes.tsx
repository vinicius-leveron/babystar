    ...
    <PhoneFrame seed={71} scroll>
      ...
      <Body scroll>
        ...
        {notifications.map((n, i) => (
          ...
          >
            <div className="flex h-10 w-10 flex-none items-center justify-center rounded-xl border border-gold/40 bg-gradient-to-br from-bg-3 to-bg-1">
              <StarLogo size={22} />
            </div>
