...
const phases = [
  ...
  { id: 'B', name: 'Temperamento', emotion: 'Curiosidade — “meu bebê é único”' },
  { id: 'C', name: 'Pressão de sono', emotion: 'Esforço recompensado — “o app entende meu bebê”' },
  { id: 'D', name: 'GPS entregue', emotion: 'Momento aha — “existe uma causa oculta e agora tenho um guia”' },
  { id: 'E', name: 'Vida com o app', emotion: 'Hábito e fidelização' },
  { id: 'F', name: 'Painel admin', emotion: 'Operação interna (desktop)' },
]

const screens = [
  { n: 1, f: '01-splash.jpg', phase: 'A', title: 'Boas-vindas', cap: 'A estrela e a promessa: o bebê permanecer dormindo.' },
  { n: 2, f: '02-onboarding.jpg', phase: 'A', title: 'Cadastro afetivo', cap: 'Nome da mãe, do bebê e data de nascimento.' },
  { n: 3, f: '03-quiz.jpg', phase: 'B', title: 'Quiz de temperamento', cap: 'Camada 1 · 6 perguntas, uma por vez.' },
  { n: 4, f: '04-resultado.jpg', phase: 'B', title: 'Resultado do temperamento', cap: 'O perfil do bebê e o que muda no sono.' },
  { n: 5, f: '05-registro-intro.jpg', phase: 'C', title: 'Intro do registro 48h', cap: 'Camada 2 · por que e como registrar.' },
  { n: 6, f: '06-registro.jpg', phase: 'C', title: 'Registro de sono', cap: 'Despertar, sonecas, noite e madrugada + progresso 48h.' },
  { n: 7, f: '07-analise.jpg', phase: 'C', title: 'Aprendendo o padrão', cap: 'A IA cruza temperamento + 48h + pressão de sono.' },
  { n: 8, f: '08-rotina.jpg', phase: 'D', title: 'Rotina personalizada', us: 'US 2.2', cap: 'Timeline pela pressão de sono ideal, por idade.' },
  { n: 9, f: '09-home.jpg', phase: 'D', title: 'Home · anel do dia', us: 'US 2.3', cap: 'Zona de aprofundamento + rotina do dia.' },
  { n: 10, f: '10-notificacoes.jpg', phase: 'D', title: 'Notificações proativas', us: 'US 2.4', cap: 'Diferente do Napper: a zona de aprofundamento.' },
  { n: 11, f: '11-timer.jpg', phase: 'E', title: 'Timer de soneca', us: 'US 2.5', cap: 'Play / pause / stop + registro automático.' },
  { n: 12, f: '12-diario.jpg', phase: 'E', title: 'Diário de anotações', us: 'US 2.7', cap: 'Mamada, fralda, peso, despertares e sono.' },
  { n: 13, f: '13-sons.jpg', phase: 'E', title: 'Biblioteca de sons', us: 'US 2.6', cap: 'Ruídos, natureza, canções + mini-player.' },
  { n: 14, f: '14-atividades.jpg', phase: 'E', title: 'Atividades do dia', cap: 'Camada 3 · gasto de energia por idade.' },
  { n: 15, f: '15-chat.jpg', phase: 'E', title: 'Chat com a Dra. Denise', us: 'US 2.1', cap: 'IA treinada pela especialista.' },
  { n: 16, f: '16-evolucao.jpg', phase: 'E', title: 'Estatísticas', cap: 'Sono total, hora de dormir, despertares.' },
  { n: 17, f: '17-paywall.jpg', phase: 'E', title: 'Paywall', cap: '7 dias grátis, planos em R$, garantia.' },
  { n: 18, f: '18-admin-prompts.jpg', phase: 'F', title: 'Editor de prompts', us: 'US 2.8', cap: 'CRUD dos prompts das camadas GPS.', wide: true },
  { n: 19, f: '19-admin-usuarias.jpg', phase: 'F', title: 'Usuárias', us: 'US 2.9', cap: 'Listagem e busca de usuárias.', wide: true },
]
...
const section = (p) => {
  ...
  <section class="phase">
    ...
    <div class="grid ${p.id === 'F' ? 'grid-wide' : ''}">${items.map(card).join('')}</div>
  </section>`
}

const usTable = [
  ['US 2.1', 'Integração com modelo de IA', 'Chat com a Dra. Denise'],
  ['US 2.2', 'Engine de rotina por idade', 'Rotina personalizada'],
...
const html = `<div class="wrap">
  <header class="hero">
    <div class="brand">
      ...
      <span class="tag">Protótipo · v1</span>
    </div>
    <h1>Jornada &amp; telas para aprovação</h1>
    <p class="lede">App de sono infantil guiado pelo <b>Método GPS</b> da Dra. Denise Gurgel — inspirado no Napper, com identidade própria: céu noturno e uma <b>estrela-guia dourada</b>. São <b>17 telas de app + 2 de painel admin</b>, cobrindo as histórias US&nbsp;2.1–2.9. Clique em qualquer tela para vê-la em tamanho cheio.</p>
    <div class="facts">
      <div><b>19</b><span>telas desenhadas</span></div>
      <div><b>3 camadas</b><span>Temperamento · Pressão · Energia</span></div>
      <div><b>US 2.1–2.9</b><span>todas cobertas</span></div>
      <div><b>PT-BR</b><span>tom mãe-pra-mãe</span></div>
    </div>
  </header>
  ...
  <footer class="foot">
    ...
    <p><b>Como é feito.</b> Front-end real, sem back-end — React + Vite + TypeScript + Tailwind + Framer Motion. Protótipo navegável no repositório <code>babystar</code> (rode <code>npm install &amp;&amp; npm run dev</code> e abra a galeria da jornada). As telas acima foram passadas por uma revisão de produto/UX/copy antes desta entrega.</p>
    <p class="fine">Persona de exemplo: mãe Amanda, bebê Olivia (9 meses) — nomes usados nos próprios documentos do método. Preços e textos comerciais são placeholders a validar.</p>
  </footer>
</div>`
...
.lede{max-width:680px;font-size:16px;line-height:1.6;color:var(--ink2);margin:16px 0 0}
